// ====================================================================================================
//
// Cloud Code for playerboostAdd, write your code here to customize the GameSparks platform.
//
...
if(trackName==playerId){
    ...
    var resultsOBJ = API.queryItems("boostsDataPlayer", query,sort);
