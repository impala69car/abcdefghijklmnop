// ====================================================================================================
//
// Cloud Code for PhotoUrlPackage, write your code here to customize the GameSparks platform.
//
...
var timeTaken = Spark.getData().Rank;
var playerId = Spark.getPlayer().getPlayerId();
var time = new Date().toISOString();
var entryName = playerId;

var API = Spark.getGameDataService();
var entry = API.createItem("urlphoto3", entryName);
